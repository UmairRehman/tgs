            ...
            <Grid xs={12} sm={12} md={6} lg={6}>
              ...
              <Grid xs={12} container>
                ...
                <Grid xs={6} container justify="flex-end">
                  ...
                  >
                    <MenuItem>
                      <Link to="/tgscrop" className={pathname === '/tgscrop' ? 'NavSelected' : ''}>TGS Corp</Link>
                    </MenuItem>
                    <MenuItem>
                      <Link to="/human-resources" className={pathname === '/human-resources' ? 'NavSelected' : ''}>Human Resources</Link>
                    </MenuItem>
                    <MenuItem>
                      <Link to="/operating" className={pathname === '/operating' ? 'NavSelected' : ''}>Operating</Link>
                    </MenuItem>
                    <MenuItem>
                      <Link to="/safety" className={pathname === '/safety' ? 'NavSelected' : ''}>Safety</Link>
                    </MenuItem>
                    <MenuItem>
                      <Link to="/track" className={pathname === '/track' ? 'NavSelected' : ''}>Track</Link>
                    </MenuItem>
                    <MenuItem>
