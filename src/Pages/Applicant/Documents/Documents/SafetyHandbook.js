...
const SafetyHandbook = () => {
  ...
  const submit = async () => {
    try {
      ...
      const step4FormsSubmitted = JSON.parse(storage.get('step-4-form-safetyHandbook')) || true;

      storage.set('step-4-form-safetyHandbook', JSON.stringify(step4FormsSubmitted));
