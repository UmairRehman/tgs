...
const LeftControl = () => {
  ...
  //         role_id: 2,
  //         buttons_enabled: ['dashboard','new-hire-queue','tickets-alerts', 'create-ticket', 'employees', 'broadcast-message','deparment'],
  //     },
  //     3: {
  //         role: 'itmanager_role',
  //         role_id: 3,
              ...
              {capabilities.dashboard.includes(role_id) && (
                <ListItem button className="DashIcon">
                  <Link
                    ...
                    className={pathname === "/dashboard" ? "NavSelected" : ""}
                  >
                    <Icon />
                    Dashboard
                  </Link>
              ...
              {capabilities.tickets_alerts.includes(role_id) && (
                <ListItem button className="AlertIcon">
                  <Link
                    ...
                    className="Liq-NavLinks"
                    className={
                      pathname === "/tickets-alerts" ? "NavSelected" : ""
                    }
                  >
                    <Icon />
                    Tickets and Alerts
              ...
              {capabilities.create_ticket.includes(role_id) && (
                <ListItem button className="CreatLinkIcon">
                  <Link
                    ...
                    className="Liq-NavLinks"
                    className={
                      pathname === "/create-ticket" ? "NavSelected" : ""
                    }
                  >
                    <Icon />
                    Create a ticket
              ...
              {capabilities.safety.includes(role_id) && (
                <ListItem button className="SafetyIcon">
                  <Link
                    ...
                    className="Liq-NavLinks"
                    className={
                      pathname === "/safety-testing" ? "NavSelected" : ""
                    }
                  >
                    <Icon />
                    Safety Testing
              ...
              {capabilities.employees_profile.includes(role_id) && (
                <ListItem button className="EmployeeIcon">
                  <Link
                    ...
                    className="Liq-NavLinks"
                    className={
                      pathname === "/employees-profile" ? "NavSelected" : ""
                    }
                  >
                    <Icon />
                    Employees Profile
              ...
              {capabilities.broadcast_message.includes(role_id) && (
                <ListItem button className="MessageIcon">
                  <Link
                    ...
                    className="Liq-NavLinks"
                    className={
                      pathname === "/broadcast-messages" ? "NavSelected" : ""
                    }
                  >
                    <Icon />
                    Broadcast Message
                  ...
                  <List component="nav" className="DeptFolder">
                    ...
                    <ListItem button>
                      <Link
                        to="/operations"
                        className={
                          pathname === "/operations" ? "NavSubSelected" : ""
                        }
                      >
                        Operations
                      </Link>
                    ...
                    <ListItem button>
                      <Link
                        to="/safety"
                        className={
                          pathname === "/safety" ? "NavSubSelected" : ""
                        }
                      >
                        Safety
                      </Link>
